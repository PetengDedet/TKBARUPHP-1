...
<div id="rootwizard">
    <div class="panel panel-default">
        <form class="form-horizontal" id="cstForm" action="{{ route('db.master.customer.create') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="tab-pane active" id="1">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="tax_id" name="tax_id" type="text" class="form-control"  value="{{old('taxt_id')}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" name="payment_due_date" id="datepicker" value="{{old('payment_due_date')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="remarks" name="remarks" type="text" class="form-control" value="{{old('remarks')}}"
                                ...
                                <fieldset class="fi">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="profileFirstName[1]" id="profileFirstName[1]"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="profileLastName[1]" id="profileLastName[1]"
                                                class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="profileAddress[1]" id="profileAddress[1]" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="profileIcNum[1]" class="control-label col-md-2">IC Num</label>
                                            <div class="col-md-10">
                                                <input type="text" name="profileIcNum[1]" id="profileIcNum[1]" class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="file" name="profileImage[1]" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody id="profPhones1">
                                                        <tr>
                                                            <td>
                                                                <select name="profilePhoneProvider[1][1]" id="profilePhoneProvider[1][1]" class="form-control" required>
